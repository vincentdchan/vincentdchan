...
- I [forked the OCaml](https://github.com/vincentdchan/ocaml) to make it compiled to WebAssembly. So you can [run the OCaml language in the browser](https://diverse.space/ocamlrun-wasm-demo/).

- I wrote a [CMake file](https://github.com/vincentdchan/quickjs) for QuickJS so that you can compile it with MSVC.
